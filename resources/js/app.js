...
elements.main.addEventListener("click", (e) => {
  ...
  } else if (e.target.closest(".detail-btn")) {
    // Detail Button
...
elements.modalContainer.addEventListener("click", async (e) => {
  ...
  if (e.target.closest(".update")) {
    ...
    const response = await state.postObj.updatePost(
      id,
    ...
    response === true
      ? postView.renderUpdateMessage(true)
      : postView.renderUpdateMessage(false);
  }
});
